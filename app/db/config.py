...
class students:
    ...
    SEED_DATA = """
        ...
        VALUES
            ("AD2231", "Celia Arellano"   ),
            ("AD8392", "Brylee Knapp"     ),
            ("AD1312", "Tru Kim"          ),
            ("AD3421", "Branson Mitchell" )
    """
...
class reports:
    ...
    SCHEMA = """
        CREATE TABLE reports(
            ...
            maths_geom      INTEGER,
            maths_stat      INTEGER,
            maths_behaviour TEXT NOT NULL,
            maths_comment   TEXT NOT NULL,

            reading_reco       INTEGER,
            reading_comp     INTEGER,
            reading_crit INTEGER,
            reading_behaviour TEXT NOT NULL,
            reading_comment           TEXT NOT NULL,

            writing_tran    INTEGER,
            writing_comp       INTEGER,
            writing_proc   INTEGER,
            writing_behaviour TEXT NOT NULL,
...
class comments:
    ...
    SEED_DATA = """
        INSERT INTO comments (subject, rating, comment)
        VALUES
            ("Maths", "Emerging", "...."),
            ("Maths", "Emerging", "...."),
            ("Maths", "Emerging", "...."),
...
#     SEED_DATA = """
#         INSERT INTO writing (transcription, composition, writing_process, comment)
#         VALUES
